...
reflecting back again from the source. This way, the power from the source does not 
transfer fully to the load. The power attenuation $\eta$ due to mismatch can be 
...
\end{equation} 
\noindent
Using the equations, the maximum efficiency of power transfer is $\eta_\mathrm{SL,\;max} 
...
efficiency of power may be approximated using an equation that is derived for 
...
\noindent
and it gives a power attenuation of $-0.22$~dB. The advantage of using a power 
...
the total attenuation grows to $-10.2$~dB, which could be a disadvantageous in 
some situations.
...
\begin{table}[!h]
	...
	%Duplex separation [MHz]						& $10 \ldots 95$							& $0 \ldots 400$						& $0 \ldots 400$	 \\
	...
	%Max. TX power [dBm]						& $+22 \ldots {+39}$						& $+10 \ldots {+33}$					& $+23$	 \\
	%Max. RX power [dBm]						& $-$										& $-25$									& $-23$	 \\
	%Max. IBB [dBm]								& $-53 \ldots {-23}$						& $-61 \ldots {-41}$					& $-23$	 \\
	%Max. OBB [dBm]								& $-27 \ldots 0$							& $-44 \ldots {-15}$					& $-23$	 \\
	%Max. NBB [dBm]								& $-$										& $-57 \ldots {-56}$					& $-23$	 \\
	%Max. spurious [dBm]						& $-30$										& $-44$									& $-23$	 \\
	%Min. ACS [dB]								& $-$										& $33$									& $33$	 \\
	%Ref. sensitivity [dBm]						& $-104 \ldots {-100}$						& $-108 \ldots {-99}$					& $-91 \ldots {-106}$	 \\
	%Linearity, min. $\mathit{IIP}_3$ [dBm]		& $+55$										& $+65$									& $+72 \ldots {+90}$
	\end{tabular}
	\end{center}
	\vspace*{-12pt}
\end{table}
...
\bibitem{2g} 3GPP Technical Specification, Series 45: 
	Radio aspects -- GSM only (Rel-4 and later)
	
\bibitem{3g} 3GPP Technical Specification, Series 25: 
	Radio aspects -- 3G and beyond / GSM (R99 and later)
	
\bibitem{4g} 3GPP Technical Specification, Series 36: 
